...
var Lt = function() {
    var t = function() {
        if (null == Ot) {
            ...
            ;
            else if ("TURBOPACK compile-time truthy", 1) t = ("TURBOPACK ident replacement", globalThis);
...
function Wt() {
    return "undefined" != "undefined" && null != window.document || "undefined" != typeof WorkerGlobalScope;
}
var Ut = i();
...
"undefined" != typeof globalThis ? globalThis : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time truthy", 1) ? ("TURBOPACK ident replacement", globalThis) : "TURBOPACK unreachable";
function er(t, e) {
    return t(e = {
        exports: {}
    }, e.exports), e.exports;
...
var rf, of = function() {
    return __turbopack_context__.r("[project]/node_modules/node-fetch/lib/index.es.js [app-ssr] (ecmascript)");
}, af = function() {
    function t() {
...
var Pf = function() {
    function t(t) {
        if (!i().getBool("IS_BROWSER") || "undefined" == "undefined" || void 0 === window.localStorage) throw new Error("The current environment does not support local storage.");
...
var Wf = function() {
    function t() {
        ...
        }), C("undefined" == "undefined" || void 0 !== window.localStorage, function() {
